...
export default function BisnisSection() {
  return (
    <section id="bisnis" className="py-24 px-6 bg-gray-950">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <span className="section-label">BAB 1 · MENGENAL BISNIS KAMI</span>
          <h2 className="text-4xl font-black text-white mt-2 mb-6">Dari Dapur ke Data: Kisah Ayam Geprek Daeng</h2>
          <div className="text-gray-300 leading-relaxed max-w-3xl space-y-4">
            <p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-2 card-dark overflow-hidden relative min-h-[300px] group"
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-gray-950 via-gray-950/40 to-transparent flex items-end p-8">
          ...
          >
            <h3 className="text-xl font-bold text-white mb-4">Keunggulan Utama</h3>
          ...
          <motion.div
            ...
            className="md:col-span-3 card-dark overflow-hidden flex flex-col md:flex-row"
          >
            <div className="md:w-1/3 p-8 flex items-center justify-center bg-red-900/20">
              <blockquote className="text-2xl font-bold text-white italic text-center leading-snug">
